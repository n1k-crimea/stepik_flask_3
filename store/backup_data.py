...
teachers = {
    ...
    1: {
        ...
        "picture": "https://i.pravatar.cc/300?img=51",
        "rating": 4.8,
        "price": 900,
...
#tmp = {random.choice(list(teachers.items()))[0]: random.choice(list(teachers.items()))[1] for i in range(3)}

t = list(teachers.items())
random.shuffle(t)
print(len(t))
...
'''with open('data.json', 'w', encoding='utf-8') as write_file:
    json.dump(teachers, write_file, ensure_ascii=False, indent=4)'''
